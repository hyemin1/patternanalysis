...
for i in range(K_test):
    Gauss_kmeans = KMeans(n_clusters=i+1, random_state=0).fit(Gauss_data) #kmeans clustering, n_clusters=number of cluster as well as centroid, random_state=determine random number of generation for centroid initialization
